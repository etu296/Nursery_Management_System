...
<section class="login-block">
	...
	<div class="row">
		<div class="col-md-4 login-sec">
			...
			<form class="login-form" action="{{route('dologin')}}" method="post" enctype="multipart/form-data">
			@csrf
...
<div class="copy-text"> Forgot your password? <a href="{{route('register')}}">Register</a></div>
		</div>
    ...
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="{{url('/frontend/images/s8.jpg')}}" alt="First slide">
