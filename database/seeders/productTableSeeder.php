...
class productTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        'product_cetagory'=>'Plants',
        'plant_cetagory'=>'Common House Plants',
